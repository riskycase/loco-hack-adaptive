...
def split_screen_to_question_and_options():
    ...
    width, height = i.size
    if(height==2160):
        frame = i.crop(((0,850,width,1200)))
        frame.save('question.png')
        frame = i.crop(((0,1220,width,1380)))
        frame.save('1.png')
        frame = i.crop(((0,1400,width,1570)))
        frame.save('2.png')
        frame = i.crop(((0,1580,width,1760)))
        frame.save('3.png')
    elif(height==1920):
        frame = i.crop(((0,760,width,930)))
        frame.save('question.png')
        frame = i.crop(((0,930,width,1100)))
        frame.save('1.png')
        frame = i.crop(((0,1100,width,1260)))
        frame.save('2.png')
        frame = i.crop(((0,1260,width,1420)))
        frame.save('3.png')
    else:
        print("Screen height not defined")
